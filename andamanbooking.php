...
<header class="bg-primary text-white text-center py-4">
    <h1>Escape to Paradise – Andaman & Nicobar Islands Tour</h1>
    <p class="lead">6 Days & 5 Nights | Where White Sands Meet Azure Seas – A Perfect Island Getaway</p>
</header>

<main class="container my-5">
    <div class="package-card">
        <h2 class="text-primary">Andaman Nicobar - 6D/5N</h2>
        ...
        <!-- Booking Form -->
        <form action="reviewandaman.php" method="POST" onsubmit="return validateForm()">
